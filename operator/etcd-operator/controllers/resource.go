...
var (
	// EtcdOperatorLabelKey is
	EtcdOperatorLabelKey = "etcd.ydzs.io/cluster"
	// EtcdOperatorCommonLabelKey is
	EtcdOperatorCommonLabelKey = "app"
	// EtcdDataDirName 定义 etcd 工作目录
	EtcdDataDirName = "datadir"
)

// MutateStatefulSet 用于生成 statefulset 资源
func MutateStatefulSet(cluster *v1alpha1.EtcdOperator, sts *appsv1.StatefulSet) {
	sts.Labels = map[string]string{
		EtcdOperatorCommonLabelKey: "etcd",
	}
	sts.Spec = appsv1.StatefulSetSpec{
		Replicas:    cluster.Spec.Size,
		ServiceName: cluster.Name,
		Selector: &metav1.LabelSelector{MatchLabels: map[string]string{
			EtcdOperatorLabelKey: cluster.Name,
		}},
...
// newContainers 定义 pod 模板
func newContainers(cluster *v1alpha1.EtcdOperator) []corev1.Container {
...
// MutateHeadlessSvc 用于生成 service 资源
func MutateHeadlessSvc(cluster *v1alpha1.EtcdOperator, svc *corev1.Service) {
